                ...
                item.active ? (
                  <li key={item.name}>
                    <button onClick={() => navigate(item.path)}
                      ...
                      className={`inline-block px-6 py-2 duration-200 hover:bg-slate-700 rounded-full text-white font-bold ${location.pathname === item.path ? 'text-yellow-400' : 'text-white'}`}>
                      {item.name}
